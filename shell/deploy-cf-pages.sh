#!/usr/bin/env bash
# 手动部署 coding-plan 到 Cloudflare Pages。
# 用法：
...
PROJECT="coding-plan"
OUT_DIR="$ROOT/out"
SITE_URL="${SITE_URL:-https://codingplan.pw/}"
SKIP_BUILD=false
...
echo "--- coding-plan -> Cloudflare Pages project: $PROJECT ---"
...
echo ""
echo "=== coding-plan Cloudflare Pages 部署完成 ==="
echo "检查地址："
echo "  https://coding-plan.pages.dev/"
echo "  https://codingplan.pw/"
