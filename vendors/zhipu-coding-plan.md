...
> 可视化页面：[https://codingplan.pw/zhipu-coding-plan/](https://codingplan.pw/zhipu-coding-plan/)
...
数据来源：[TokenPlan 详情：https://tokenplan.vip/zhipu-coding-plan](https://tokenplan.vip/zhipu-coding-plan)
...
- 国产模型生态
- AI 编程订阅
- 价格、额度和可用模型变化较快，需要关注 TokenPlan 实时页面

## TokenPlan 详情

- [GLM Coding Plan 详情](https://tokenplan.vip/zhipu-token-plan)
